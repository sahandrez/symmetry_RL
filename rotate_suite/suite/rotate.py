...
def get_model_and_assets():
  ...
  return common.read_model('common/pendulum.xml'), common.ASSETS


@SUITE.add('rotate')
def my_swingup(time_limit=_DEFAULT_TIME_LIMIT, random=None,
               environment_kwargs=None):
  """Returns pendulum swingup task ."""
  physics = Physics.from_xml_string(*get_model_and_assets())
  task = MySwingUp(random=random)
